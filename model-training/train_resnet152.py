...
# استيراد النموذج
from models.resnet152_model import ResNet152Model, train_resnet152
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train a ResNet152 model for chest X-ray classification')
...
def main():
    ...
    # تدريب النموذج
    model, best_auroc = train_resnet152(
